...
1. A way for community members to easily set up blogs that integrate with and can refer to other elements of the Lionsberg Wiki. See [[Lionsberg Wiki Blogs]]. 
2. A way for community members to easily publish books / manuscripts. For a starting point, see the work we did with: 
...
3. A way for community members to align their [[Daily Practice]] with the total Integrated System - See [[The Power of Today]]. 
4. A [[Your Starting Point|Starting Point]] for individuals to dive in and begin self-orienting 
5. A place for people to begin telling their stories - in response to a few requests, I went first with a quick version here: [[Jordan Nicholas Sukut]].
6. Began a secondary start through the social experiment with friends in Africa.
7. Began formalizing a data ontology for interoperability among data sets through the Catalist and Map Weavers groups. 
