...
We are issuing this [[Requests For Guidance]] at the outset of our third 6 Week Cycle. 
...
2. An initial concept, philosophy, and framework of Value Creation (also contained in the [[2022.Q2 Presentation of Value Creation]]).   
...
1. If you see value in what we are co-creating, and in the far greater things that are possible if we work together, please let us know by making a donation at http:Lionsberg.org/donate. Any show of support helps build social and proof, and encourage the emerging community. Each month, we will transparently steward and allocate any funds raised to advance the [[Critical Path]] towards the Goal. 
