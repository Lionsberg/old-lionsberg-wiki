...
Disposal and cleansing systems for toxins and waste, and their local, regional, and global interrelationships and impacts will be determined. Primary sources and Root Causes of waste and toxins will be identified, and frameworks will be established to empower local instantiations of the System to stop waste and toxins at their source, while cleansing and regenerating the [[Living System]]. Major toxin and waste hubs will be identified, with plans for short and medium term management and long term elimination. Special attention will be paid to systems and methodologies for dealing the small perce

·      **Disaster Prevention and Emergency Response**

Disasters will be analyzed and categorized, and root cause analysis performed. Appropriate prevention and response systems will be intelligently established based on risk analysis amplified for future uncertainty and unpredictability. All planning and analysis should be based on the fact that we are entering an entirely unpredictable new season of life on earth, which may be far less stable than the recent past until the System has been established and the wounds have been healed. Systems that are fragile to unpredictability  should be transformed. This analysis should apply to disasters of every type, across all systems, including but not limited to natural, political, social, and health systems. This element of the plan should not be underestimated. In seasons of historic transition and transformation, we cannot overprepare or become overly antifragile.

·      **Energy**

Energy systems, and their local, regional, and global interrelationships and impacts will be determined. Primary requirements will be established and listed by region. General fractal deployment concepts to make the energy from the sun, wind, and gravity available in all domains of inhabitation will be articulated. Major energy transport systems will be re-evaluated, and a global plan established for sovereign local energy access enacted.

·      **Aesthetics, Recreation, and Comfort**
...
·      **Systems of Sovereignty and Justice**
...
The individual sovereignty and worth of all sacred forms of life, and especially of conscious human beings, is not for sale or exploitation. All systems of justice and delegation of authority shall be re-evaluated as necessary to return individual and local sovereignty and justice to local communities and ecosystems The System shall ensure that all authority flows properly from its Source throughout the living system without corruption or interruption. All rights to exploit any form of life, or remove its individual sovereignty, shall be systematically revoked and transformed into new agreements which establish and respect the irrevocable sovereignty, rights, and responsibilities of each individual being in direct right relationship to all other beings.

·      **Specifications**

A draft of General Conditions, Sections 0 and 1 will be provided.  All other sections, will be delineated in draft outline utilizing (Construction Specifications Institute (CSI) (TBD) format.  The performance level specifications will appropriately describe the work as it is determined at this time.  The Specifications, this Program Delivery Guide, and the Forging the New World manuscript will be formatted and made available digitally in as many languages as possible relatively simultaneously around the globe. **_This is critical so that the pattern language can be activated in unison by IPD Teams around the world, around interconnected local and regional nodes, so that the pattern of transformation / global movement towards the Goal cannot be interrupted by any attack_**.

·      **Program Schedule**

An overall program schedule will be developed and will reflect key milestones established in conjunction with the plans and pull planning sessions including all stakeholders. 

The schedule will be broken out into a work breakdown structure (WBS) that will incorporate both all relevant systems, goals, and Action Domains, as well as regional and cultural Integration Domains.

The schedule will be updated, cycled, and published no less than every two weeks, with a formal update presented to the Global Community each month.

·      **Mission Control Guild**

A Mission Control Guild has been established to provide rigorous program controls, variance reporting.

Mission Control shall include an intelligent dashboard that tracks activity, progress, and issues across all IPD Teams. The IPD Dashboard will flag issues and variances, and provide “Green, Yellow, Red” health indicators for all IPD Teams and Initiatives across all Domains.

·      **Domain Councils**  

Each Action Domain and each Integration Domain will establish a Domain Council to discern and guide intention and strategy. Domain Council’s operate in service and support to the leaders, organizations, and best ideas being generated in a given domain. The highest intention and strategy that the Domain Councils can discern will be funded / empowered / accelerated for successful IPD Team implementation.
...
·      **Integrated Project Delivery Teams (IPD Teams)**   

IPD Teams will take responsibility for executing on the intention and strategy discerned by the Domain Councils, and for regularly reporting on progress, issues, and improvements.

IPD Teams will be intentionally developed and balanced to ensure a proper array of personality types, skill sets, and leadership on each team. IPD Teams will be designed so that they can function and carry out the responsibilities delegated to them regardless of connection to the Meta Project infrastructure and services that support them.

The global network of IPD Teams should plan for periodic separation in their ability to communicate with and receive support from Headquarters.

Accordingly, each IPD Team should have an embedded Headquarters element to serve as a advocate / liason between Headquarters and the IPD Team.
...
Guilds should establish programs for discerning aptitude, apprenticing, and ensuring continuity of development and deployment among its members.

·      **Headquarters**   

The Receiver and PM shall establish digital and physical headquarters to guide, empower, and coordinate the efforts of the globally distributed IPD Teams. Headquarters shall ensure that IPD Teams, while operating in functional unity, are each strong, self-sustaining and capable of surviving and accomplishing the Goal even if they were to lose contact with Headquarters or a portion of the global IPD Teams for a significant period of time.

Headquarters shall train, empower and embed HQ elements in each IPD Team to represent and advocate for the integrity, understanding, and optimization of the Whole to the IPD Team, and to advocate for the sovereignty and local issues and needs of the IPD Team to HQ and Mission Control.

·      **Program Logistics**

The Prototype Team will establish operational criteria for the service departments required to empower the network of IPD Teams, and determine how to connect up a variety of such departments around the globe with knowledge, resources, and information / best practices sharing. These connections should include how to leverage global attention and aggregated purchasing power for major cost components, while focusing of local sourcing and capacity building to strengthen local domains. Logistics systems should ensure that IPD Teams have a way to communicate needs and gaps in resources, in a way that the Program can respond to.  

The following Consultant Guilds have been identified as key participants in the future refinement of the prototype and kit of parts:

1.     **Regulatory and Code Consultant**—A strategy and plan will be developed to keep the Program in compliance with various global jurisdictions, while transforming laws and authority where they stand in the way of the wellbeing of life.

2.     **Security Consultant**—Communication, electronic, IT, software, hardware, conferencing, and physical security systems will be identified, described, specified, and mapped. Security plans for global operations in dangerous zones shall be specified and mapped. Security plans, as they are developed, should provide frameworks for identifying and transforming the root causes of violence and fear in an area.
...
Deployment of appropriate resources requires organizing around the processes necessary to efficiently and effectively complete each phase of the Program. A single, Functional Organization Chart (“FOC”) is being created which treats all IPD team members as members of a single entity, as if they all operated within a single organization.  It is designed to use the best resources available on the Program regardless of that resource’s “home” organization.[[1]](#_ftn1)
...
The FOC is shown on the following 12 pages.
...
[[1]](#_ftnref1) The FOC process is based on extensive research into “Process-based Management” by Dr. Michael Hammer of MIT, who wrote “Reengineering the Corporation” in 1996. Dr. Hammer’s thesis “promoted the idea of simplifying and reorganizing business departments by having the workers break down their activities into logical, bite-size pieces, then take a ‘clean sheet’ approach to reassembling their work for greater efficiency and productivity.”