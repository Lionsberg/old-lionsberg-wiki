...
And that Program Statement can be thought of as calling forth a continuously improving / transforming [[System]], composed of sub-systems or processes. 
...
Providing efficient IT solutions for BIM users and the design/build teams requires that all stakeholders collaborate on a comprehensive statement of their mutual expectations and [[Conditions of Satisfaction]] for the entire BIM suite of systems.  A BIM [[Special Action Team]] will be organized and will meet regularly. It will be charged with developing collaborative understanding, processes, and procedures. 

**Architectural and Engineering Software** - in addition to choosing specific software functionalities and cross-platform programs, the BIM team will develop the protocols and procedures for implementation.  

Consensus on products, usage, best practices, procedures and protocols will be made pursuant to a comprehensive [[Decision Making Process]] that specifically includes input and support froma diversity of stakeholder groups. 
