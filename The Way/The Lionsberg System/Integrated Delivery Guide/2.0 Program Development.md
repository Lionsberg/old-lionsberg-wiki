...
- **Administrative/Operational Support**:  This includes the PM's office management that handles logistics coordination and client/executive support, document control and all areas of financial management, including:

o   Accounting and Contracts—responsible for processing invoices, preparing monthly billing, managing cash-flow projections, performing budget transfers, contract management, contract renewals, and maintaining compliant sub/consultant certificates of insurance.

o   Cost Controls—responsible for budget establishment, assigning cost codes, ensuring cost is aligned with cost projections, cost control software oversight (e.g. Prolog).[[2]](#_ftn2)

·      **Management Information Systems/Information Technology (MIS/IT)—a**ssists with technical setup, including but not limited to video conferencing, software installation and maintenance, information backups, MIS/IT daily troubleshooting and after hours support, and managing office software tools, including:

o   Document Locator**:**  the PM's records management solution for capturing, managing, sharing, and securing the documents and information.

o   Community Hub**:**  The Program’s community "hub" for posting and exchanging information related to the efforts, initiatives, announcements, polls, and current events.

o   Viewpoint (TBD)**:**  The Program’s current cost management tracking system, which captures contracts activity, expenditures and reporting.

  

---

[[1]](#_ftnref1) See fn. 14

[[2]](#_ftnref2) For purposes of this guide, the Administrative/Operational Support will focus on financial management, which is discussed in Section 2.2.1.