...
Current IT responsibility includes: 

-   Building Information Modeling  
-   Architectural, Engineering, and Systems Design rendering software  
...
The PM will develop a plan for the hardware and capacity required to run all Program technology.  As specific projects commence, additional hardware may be required at Project sites to power the chosen software systems.
...
-   Platform selections will need to consider access issues for members of the SLE, necessary Trade Partners and the CPR.

**Building Information Modeling**

Providing efficient IT solutions for BIM users and the design/build team required that all stakeholders collaborate on a comprehensive statement of their mutual expectations and Conditions of Satisfaction for the entire BIM suite of systems.  A BIM Special Work Action Team will be organized and will meet regularly. It will be charged with developing collaborative understanding, processes, and procedures. In developing solutions, the BIM Special Work Action Team has developed the following guidelines:

**Architectural and Engineering Software**—in addition to choosing specific software functionalities and cross-platform programs, the BIM team will develop the protocols and procedures for implementation.  Consensus on products, usage, best practices, procedures and protocols will be made pursuant to a comprehensive decision-making plan that specifically includes support from the PM and Leadership at all IPD teams.

**Ordering and Clash detection across multiple platforms** – The BIM team must first investigate and choose appropriate software.  This may include patching together a suite of software products or selecting a single product which incorporates the functionality of many tools in ordering and clash detection.  Once the software solution has been chosen, the BIM team will collaboratively develop an implementation plan including the identification of roles and responsibilities to all the potential users/stakeholders.  Decisions in this area will be communicated to all the stakeholders for implementation of the chosen software including policies, procedures and protocols for its access, use and data retention.

**Real-time estimating (model based costing)** – The BIM team strategy includes a plan of action, software selection and multiple White Papers (in progress) studying how to implement model based costing using the chosen BIM platform and related software.

BIM is a very fluid technology and constantly evolving. The choice of BIM tools is important, but more important is the manner in which these tools are implemented. Optimizing the use of BIM requires constant improvement and re-assessment of the adapted implementation strategies. (For a discussion of the benefits of BIM and how it will be used at the Project Sites, see Section 3.1.5.1, at page 97.)

**Records Management**

A record is a document or other electronic or physical object generated or received by an organization which serves as evidence of an activity or transaction engaged in by the organization that requires retention for some time period.  Records management is the process by which an organization:
...
#### ·      Researches and implements technological solutions and business processes to help ensure that the organization complies with its records management obligations in a cost-effective and non-wasteful manner
...
Document Control oversees the comprehensive document management system used on the Program.  A computer-indexed filing system is used for all internal and external, design and construction related documents.  Document Control establishes and maintains procedures for document management, archiving and records requests for the Program. 

·      Document Locator (TBD) is the Program’s document management software solution for capturing, managing, sharing, and securing the documents and information. Document management spans the entire document life cycle, from electronic origination or document scanning, through collaboration, workflow management and document sharing, to version control, auditing, document retrieval and document storage.

·      Document Locator interfaces with other standard software such as MS Word, Excel, PowerPoint, and Outlook.  This interface allows Program participants to electronically collaborate on documents using version control and the check in/check-out features.

**Financial Management**

Financial management records are discussed in the next section, 2.2.2. 
...
#### ·      Ability to manage sensitive information restricting access to “need to know”

#### ·      Tracking program team resource skills, expertise and experience to be available through on-line searches
...
The Program uses the following communication processes:  These need to become real processes actually in use on the program.

·      **Common calendaring** – selection of software calendaring that overcomes the firewalls of various entities and can be integrated into Outlook.

·      **Commitment logging** – From RbPD to Pull Planning, a hallmark of lean processes is the making and keeping of reliable promises which get recorded and tracked.  PM will find a non-labor-intensive system to do this, across remote locations, if needed.

·      **Access to records and BIM** – The defensive firewalls of the various organizations and institutions in the SLE are virtual barriers to access to records and BIM files.  The Technology Guild will design a solution to overcome these challenges.

·      **Collaboration processes** – Collaboration takes place best when face-to-face, but with an inherently global mission, teams must become world-class a virtual collaboration. Virtual collaboration solutions should include ways to efficiently map field across the different management and coordination solutions in place.

·      **Protocols and Processes** – For all of the above challenges, finding the IT solution is only one part of the challenge.  The SLE team must then collaboratively develop the policies, protocols and processes which knit all the solutions together and weave them into the daily work habits of hundreds, thousands, and eventually millions of people around the world.

**Work Structuring**

The Program also uses software and technological solutions to address the following issues of project delivery:
...
It is anticipated that many of the ultimate processes and applications of the NWOS will run on a new global blockchain.
...
A new system will be established to allow Program participants to measure, validate, and exchange value as they create it. This system will enable new digital currency within the Prototype, and be closely coordinated with the NWOS currency concepts. The current hypothesis is that local communities should be able to locally exchange value,  while remaining interoperable with global exchange mechanisms.

Measuring and exchange of value will be a core element used for allocation of funds.
...
-   **Security**:  Appropriate access to information is essential for the Program.  Security includes electronic access controls.  Electronic access is managed by role-based rights whenever possible.  Further security is provided by restricting access to the system through a single point of access.
-   **Storage (Data):**  A data storage protocol will be developed, implemented, and continuously improved.
-   **Backup**:  Data backup is the foundation of any disaster recovery program.  The backup should provide the ability to restore lost data in a reasonable time frame.  System architecture should ensure that data is stored in locations designated for security and backup, and not fragmented across many different locations.
...
-   **Service** **and Support**:  The Program service desk provides easy access to support service not only for IT, but for other services as well.

#### The IT system should provide monitoring and reporting of systems and processes throughout the Program information management systems.
